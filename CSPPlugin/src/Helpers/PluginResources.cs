namespace Loupedeck.CSPPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.CSPPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.CSPPlugin.Resources.Resource.txt`.
